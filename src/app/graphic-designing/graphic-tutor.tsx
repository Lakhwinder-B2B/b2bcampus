            ...
            <div className="row align-items-center">
                ...
                <div className="col-sm-6 col-6 col-md-4 col-lg-3">
                    <div className="shadow text-center text-white p-4">
                        ...
                        <h1 className="fs-4 m-0 text-dark font-bold">Vikash</h1>
                        <p className="fs-6 p-0 m-0 text-dark">Web Development Expert</p>
                    </div>
                </div>
        ...
        <div className="row align-items-center">
                <div className="col-sm-6 col-12 col-md-4 col-lg-4 ">
                    <div className="text-white p-4">
                        <img className="mb-4 border-grid" src={C7.src} alt=""/>
                      </div>
                </div>
                <div className="col-sm-6 col-12 col-md-4 col-lg-4 ">
                    <div className="text-white p-4 ">
                ...
                <div className="col-sm-6 col-12 col-md-4 col-lg-4 ">
                    <div className="text-white p-4">
                        <img className="mb-4 border-grid" src={C8.src} alt=""/>
                    </div>
                </div>
                ...
                <div className="col-sm-6 col-12 col-md-4 col-lg-4 ">
                    <div className="text-white p-4">
                        <img className="mb-4 border-grid" src={C9.src} alt=""/>
                      </div>
                </div>

                <div className="col-sm-6 col-12 col-md-4 col-lg-4 ">
                    <div className="text-white p-4">
                        <img className="mb-4 border-grid" src={C10.src} alt=""/>
                      </div>
                </div>
            </div>
        </div>
